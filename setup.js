//Definere en masse variabler, såsom start key.
...
let liv = 3; // Definere hvor mange liv man har.
let livscore = new Livscore (); // Viser antallet af liv.
...
// create menu texts
let startText = new TextObject( //Ændret til F
    "Press [F] to start" // text
);

let flapText = new TextObject( //Ændret til F
